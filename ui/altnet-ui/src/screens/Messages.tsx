      ...
      <div className="rounded-2xl border border-white/10 bg-white/5 p-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="h-[42px] w-[42px] shrink-0 rounded-xl border border-white/10 bg-white/5 text-white/80 hover:bg-white/10 disabled:opacity-60 disabled:cursor-not-allowed flex items-center justify-center"
            disabled={attachBusy}
